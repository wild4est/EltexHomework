 ...
 * \param struct sockaddr_in* addr - указатель на структуру адресса клиента
 */
 ...
 * \param struct Client* client - указатель на вершину клиента, которая будет добавлена в список
 */
 ...
 * \param struct sockaddr_in* new_addr - указатель адрес клиента, по которому его будут искать
 * \return В случае, если клиент был найден вернётся указатель на его структуру. В ином случае возвращается NULL
 */

 ...
 * \param struct Server* server - указатель на струтуру сервера, которая будет
 * инициализирована
 ...
 * \param struct sockaddr_in* addr - адресс, по которому будет полученно
 * сообщение
 * \return Число, обозначающее успех операции. -1 - произошла ошибка.
 * 0 - всё прошло успешно. 1 - от сервера было получено сообщение о завершении
 * работы.
 */
 ...
 * \param struct Client* client - указатель на стрктуру клиента, которому будет
 * отпралвено сообщение
 ...
 * \return Число, обозначающее успех операции. -1 - произошла ошибка. 1 - всё
 * прошло успешно.
 * \detail Во время отправки к концу сообщения добвляется
 * количество сообщений, которые клиент отправил
 */
 ...
 * \param struct Server* server - указатель на структуру сервера, которая будет
 * удалена
 */

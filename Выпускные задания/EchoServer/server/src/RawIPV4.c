...
void FillPacketUDP(struct Packet_UDP* packet_udp, uint16_t port_source, uint16_t port_destination, char* msg){
	packet_udp->source_port = port_source;
	packet_udp->destination_port = port_destination;
...
void FillPacketIPV4(struct Packet_IPV4* packet_ipv4, uint32_t ip_addr_source, uint32_t ip_addr_destination, struct Packet_UDP* packet_udp){
	...
	packet_ipv4->destination_address = ip_addr_destination;
...
int PacketIPV4Check(struct Packet_IPV4* packet_ipv4, uint32_t source_address, uint16_t source_port){
	...
	int port_check = packet_ipv4->packet_udp.destination_port == source_port;

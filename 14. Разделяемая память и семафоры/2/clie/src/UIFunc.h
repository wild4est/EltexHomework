 ...
 * создании соотвествующего потока.
 * \param void* args - указатель на структуру клиента
 * \detail Функция ждёт пока пользователь не введёт вообщение в окне
 ...
 * создании соотвествующего потока.
 * \param void* args - указатель на структуру клиента
 * \detail Функция ждёт пока не поуступит сообщение от сервера и
 * обрабатывает его.
 */

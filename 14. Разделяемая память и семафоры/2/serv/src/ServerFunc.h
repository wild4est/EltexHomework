 ...
 * памяти для принятия запросов на принятие в чат \param struct SharedMemory
 * shared_mem_messaging - структура разделяемой памяти для принятия сообщений в
 * чате \param struct SharedMemory shared_mem_exit - структура разделяемой

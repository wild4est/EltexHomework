 ...
 * \param struct ListMsg* list_msg - указатель на список сообщейни, куда будет добавлена вершина
 ...
 * \param struct ListMsg* list_msg - указатель на список сообщений, откуда будет удалено сообщение
 * \param char* msg - сообщение
 */
 ...
 * \param struct ListMsg* list_msg - указатель на список сообщений, который необходимо удалить
 */
 ...
 * \param struct ListClient* listclient - указатель на список клиентов, куда будет добавлена вершина
 ...
 * \param struct ListCLient list_client - список клиентов, откуда будет удалена вершина
 * \param char* name - имя клиента
 */
 ...
 * \param struct ListClient* list_client - список клиентов, который необходимо удалить
 */
